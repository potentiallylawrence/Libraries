...
if not isfile("Minecraftia.ttf") then
	writefile("Minecraftia.ttf", game:HttpGet("https://github.com/potentiallylawrence/Utility/raw/refs/heads/main/Fonts/Minecraftia/Minecraftia-Regular.ttf"))
end
if isfile("MenuFont.font") then
	delfile("MenuFont.font")
end
--
local Library = {};
do
	...
	do
		...
		Font:Register("MenuFont", 400, "normal", {Id = "Minecraftia.ttf", Font = ""});
	end
		...
		function Library:Resize(object, background)
			...
			Library:Connection(Mouse.Move, function(input)
				if dragging then
					...
					local X = math.clamp(MouseLocation.X - background.AbsolutePosition.X, 100, 9999)
					local Y = math.clamp((MouseLocation.Y - 36) - background.AbsolutePosition.Y, 100, 9999)
	...
	function Library:Notification(message, duration, color)
		...
		Value.Name = "Value"
		Value.FontFace = Font.new(Font:GetRegistry("MenuFont"))
	        Value.RichText = true
		Value.Text = message
	...
	do
		...
		function Library:Window(Options)
			...
			Title.Name = "Title"
			Title.FontFace = Font.new(Font:GetRegistry("MenuFont"))
		...
		function Library:Page(Properties)
			...
			PageName.FontFace = Font.new(Font:GetRegistry("MenuFont"))
		...
		function Sections:Toggle(Properties)
			...
			function Toggle:Keybind(Properties)
				...
				Hold.ZIndex = 2
				Hold.FontFace = Font.new(Font:GetRegistry("MenuFont"))
				Hold.Text = "Hold"
				...
				Toggle.ZIndex = 2
				Toggle.FontFace = Font.new(Font:GetRegistry("MenuFont"))
				Toggle.Text = "Toggle"
				...
				Always.ZIndex = 2
				Always.FontFace = Font.new(Font:GetRegistry("MenuFont"))
				Always.Text = "Always"
		...
		function Sections:List(Properties)
			...
			Icon.Name = "Icon"
			Icon.FontFace = Font.new(Font:GetRegistry("MenuFont"))
			Icon.Text = "+"
			...
			local function createoptions(tbl)
				for _, option in next, tbl do
					...
					OptionLabel.FontFace = Font.new(Font:GetRegistry("MenuFont"))
		...
		function Sections:Button(Properties)
			...
			function Button:Button(Properties)
				...
				iValue.Name = "Value"
				iValue.FontFace = Font.new(Font:GetRegistry("MenuFont"))
		...
		function Pages:PlayerList(Properties)
			...
			local function createoptions(tbl)
				for i, option in next, tbl do
					...
					PlayerName.FontFace = Font.new(Font:GetRegistry("MenuFont"))
					...
					PlayerStatus.FontFace = Font.new(Font:GetRegistry("MenuFont"))
		...
		function Library:Indicator(Properties)
			...
			function Indicator:NewValue(Properties)
				...
				IndValue.FontFace = Font.new(Font:GetRegistry("MenuFont"))
			...
			function Indicator:NewBar(Properties)
				...
				Title1.Name = "Title"
				Title1.FontFace = Font.new(Font:GetRegistry("MenuFont"))
				...
				IndValue1.FontFace = Font.new(Font:GetRegistry("MenuFont"))
				IndValue1.Text = "0"
